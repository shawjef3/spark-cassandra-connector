...
trait SaiCollectionBaseSpec extends SaiBaseSpec {
  ...
  def indexOnANonFrozenCollection(table: String, column: String): Unit = {
    "allow for contains predicate push down" in dseFrom(V6_8_3) {
    ...
    "allow for multiple contains predicate push down" in dseFrom(V6_8_3) {
    ...
    "not allow for equal predicate push down" in dseFrom(V6_8_3) {
  ...
  def indexOnAFrozenCollection(table: String, column: String): Unit = {
    ...
    "allow for equality predicate push down for pk column" in dseFrom(V6_8_3) {
